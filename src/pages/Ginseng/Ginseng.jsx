        ...
        <Box className="">
            ...
            <div className="">
                ...
                <Box className="w-[100%] container max-lg:flex-wrap m-auto flex items-start justify-between mb-10">
                    <Box className="w-[30%] max-md:w-[30%] m-auto flex items-center flex-col">
                        <Image className="flex items-center m-auto mb-7" src={Img2} alt="ginseng-img2" />
                        <Heading className="w-[60%] max-lg:w-full max-sm:text-base m-auto text-2xl font-[600]" as="h3">{t("ginseng.title.3")}</Heading>
                    </Box>
                    <Box className="w-[30%] max-md:w-[30%] m-auto flex items-center flex-col">
                        <Image className="flex items-center m-auto mb-7" src={Img3} alt="ginseng-img3" />
                        <Heading className="w-[60%] max-lg:w-full max-sm:text-base m-auto text-2xl font-[600]" as="h3">{t("ginseng.title.4")}</Heading>
                    </Box>
                    <Box className="w-[45%] max-lg:w-full max-lg:text-center max-lg:mt-7">
                ...
                <Box className="max-lg:text-center  container mb-10">
                    <Heading className="text-2xl mb-4 font-[600]" as="h3">{t("ginseng.title.6")}</Heading>
                    <Text as="p">{t("ginseng.text.4")}</Text>
                </Box>

                <Box className="max-lg:text-center  container mb-[10]">
                    <Image className="w-[80%] max-lg:w-full flex items-center m-auto mb-11" src={Img4} alt="ginseng-img4" />
                    <Text className="mb-8 font-[600]" mb={30} as="p">{t("ginseng.title.7")}</Text>

                    <Text className="mb-8 font-[600]" as="p">{t("ginseng.title.8")}</Text>

                    <Image className="w-[90%] max-lg:w-full flex items-center m-auto mb-11" src={Img5} alt="ginseng-img5" />

                    <Text className="mb-8" as="p">{t("ginseng.text.5")}</Text>
                </Box>

                <Box className="max-lg:flex-col max-lg:w-full container flex items-center justify-between mb-10">
                    <Box className="w-[50%] max-lg:w-full max-lg:text-center max-lg:mb-6">
                    ...
                    <Image className="w-[40%] max-lg:w-[60%] flex items-center m-auto" src={Img6} alt="ginseng-img6" />
                </Box>
                ...
                <Box className="max-lg:flex-col max-lg:w-full container flex items-center justify-between mb-10">
                    ...
                    <Image className="w-[40%] max-lg:w-full max-lg:mb-6 flex items-center m-auto" src={Img16} alt="ginseng-img16" />
                </Box>


                <Image className="container w-[65%] max-lg:w-full flex items-center m-auto mb-10" src={Img7} alt="ginseng-img7" />

                <Box className="container max-lg:w-full max-lg:text-center mb-12" as="ul">
                ...
                <Box className="max-lg:flex-col container flex justify-between mb-10">
                    <Box className="w-[25%] max-[1280px]:text-center max-lg:w-full max-lg:mb-8">
                        <Image className="max-lg:w-[50%] flex items-center m-auto mb-5" src={Img8} alt="ginseng-img8" />
                        <Heading className="max-[1280px]:text-base max-lg:text-base text-2xl font-semibold mb-3" as="h3">{t("ginseng.title.12")}</Heading>
                        <Text className="text-xs">{t("ginseng.text.8")}</Text>
                    </Box>

                    <Box className="w-[25%] max-[1280px]:text-center max-lg:w-full max-lg:mb-8">
                        <Image className="max-lg:w-[50%] flex items-center m-auto mb-5" src={Img9} alt="ginseng-img9" />
                        <Heading className="max-[1280px]:text-base max-lg:text-base text-2xl font-semibold mb-3" as="h3">{t("ginseng.title.13")}</Heading>
                        <Text className="text-xs">{t("ginseng.text.9")}</Text>
                    </Box>

                    <Box className="w-[25%] max-[1280px]:text-center max-lg:w-full max-lg:mb-8">
                        <Image className="max-lg:w-[50%] flex items-center m-auto mb-5" src={Img10} alt="ginseng-img10" />
                        <Heading className="max-[1280px]:text-base max-lg:text-base text-2xl font-semibold mb-3" as="h3">{t("ginseng.title.14")}</Heading>
                        <Text className="text-xs">{t("ginseng.text.10")}</Text>
                    </Box>
                </Box>

                <Image className="container w-[65%] max-lg:w-full flex items-center m-auto mb-10" src={Img11} alt="ginseng-img11" />

                <Box className="container max-lg:flex-col flex justify-between m-auto mb-10">
                    <Box className="w-[45%] max-lg:w-full max-lg:text-center max-lg:mb-8">
                        <Box className="mb-8">
                ...
                <Box className="py-10 mb-10 bg-[#FAFAFA]">
                    <Heading className="max-lg:text-xl text-center font-semibold text-2xl mb-7" as="h3">{t("ginseng.title.22")}</Heading>

                    <Box className="max-lg:grid max-lg:grid-cols-1 container flex items-center justify-center">
                        <Box className="w-[35%] max-lg:w-full">
                            <Box className="mb-8 max-lg:text-center">
                        ...
                        <Image className="w-[35%] max-sm:w-full max-lg:w-[50%] flex items-center m-auto mb-10" src={Img12} alt="ginseng-img12" />
                ...
                <div className="container">
                    ...
                    <Box className="max-md:flex-col flex items-center justify-between mb-14">
                        ...
                        <Box className="w-[30%] max-md:mb-8 max-sm:text-center max-md:w-full">
                            <Image className="w-[100%] max-md:w-[60%] flex items-center m-auto mb-5" src={Img14} alt="ginseng-img13" />
                            <Heading className="max-[1280px]:text-xl text-2xl font-semibold mb-3" as="h3">{t("ginseng.customerTitle.2")}</Heading>
                            <Text className="text-sm leading-6" as="p">{t("ginseng.customerText.2")}</Text>
                        </Box>

                        <Box className="w-[30%] max-md:mb-8 max-sm:text-center max-md:w-full">
                            <Image className="w-[100%] max-md:w-[60%] flex items-center m-auto mb-5" src={Img15} alt="ginseng-img13" />
                            <Heading className="max-[1280px]:text-xl text-2xl font-semibold mb-3" as="h3">{t("ginseng.customerTitle.3")}</Heading>
                            <Text className="text-sm leading-6" as="p">{t("ginseng.customerText.3")}</Text>
                        </Box>
                    </Box>

                    <Box className="max-lg:flex-col max-[1280px]:flex-col flex items-center justify-between mb-14">
                        <Image className="container w-[40%] max-[1280px]:w-[50%] max-lg:w-full flex items-center m-auto mb-5" src={Img16} alt="ginseng-img13" />
                        <Link to="/contact" className="max-[1280px]:text-sm bg-red py-5 px-6 rounded-xl text-[white] hover:bg-[#611a17] transition-all">{t("ginseng.btn")}</Link>
                    </Box>
                </div>
            </div>
        </Box>
